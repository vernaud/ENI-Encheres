...
INSERT INTO bd_trocencheres.dbo.ARTICLES_VENDUS (no_article, nom_article, description, date_debut_encheres, date_fin_encheres, prix_initial, prix_vente, no_utilisateur, no_categorie)
VALUES (2, N'Machine de Turing', N'Le calculateur qui a cassé enigma.', N'1970-09-18', N'1970-10-22', 250000, 250000, 6, 1);
INSERT INTO bd_trocencheres.dbo.ARTICLES_VENDUS (no_article, nom_article, description, date_debut_encheres, date_fin_encheres, prix_initial, prix_vente, no_utilisateur, no_categorie)
VALUES (3, N'Abonnement Tan 1an', N'Abonnement au réseau Tan.', N'2021-07-01', N'2021-07-04', 10, null, 1, 1);
INSERT INTO bd_trocencheres.dbo.ARTICLES_VENDUS (no_article, nom_article, description, date_debut_encheres, date_fin_encheres, prix_initial, prix_vente, no_utilisateur, no_categorie)
VALUES (4, N'iPhone 12', N'Reçu à noël, je ne l''ai jamais utilisé parce que je préfère windows phone.', N'2021-07-02', N'2021-07-13', 2000, null, 2, 1);
INSERT INTO bd_trocencheres.dbo.ARTICLES_VENDUS (no_article, nom_article, description, date_debut_encheres, date_fin_encheres, prix_initial, prix_vente, no_utilisateur, no_categorie)
VALUES (6, N'Maillot Jordan Bulls 98', N'Maillot porté par Michael Jordan durant la finale de 1998 avec les Chicago Bulls.', N'2003-05-14', N'2003-06-21', 397, null, 3, 3);
INSERT INTO bd_trocencheres.dbo.ARTICLES_VENDUS (no_article, nom_article, description, date_debut_encheres, date_fin_encheres, prix_initial, prix_vente, no_utilisateur, no_categorie)

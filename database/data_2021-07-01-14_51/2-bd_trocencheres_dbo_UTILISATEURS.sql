...
INSERT INTO bd_trocencheres.dbo.UTILISATEURS (no_utilisateur, pseudo, nom, prenom, email, telephone, rue, code_postal, ville, mot_de_passe, credit, administrateur)
VALUES (3, N'enchèreLimite', N'Misérable', N'Gavroche', N'jai-pas-de-maison-pas-argent-mais-je-troque@mail.com', N'6578951232', N'dans la rue', N'75000', N'Paris', N'123', 15, 0);
INSERT INTO bd_trocencheres.dbo.UTILISATEURS (no_utilisateur, pseudo, nom, prenom, email, telephone, rue, code_postal, ville, mot_de_passe, credit, administrateur)
...
INSERT INTO bd_trocencheres.dbo.UTILISATEURS (no_utilisateur, pseudo, nom, prenom, email, telephone, rue, code_postal, ville, mot_de_passe, credit, administrateur)
VALUES (6, N'historique', N'Bonaparte', N'Napoléon', N'np@mafrance.fr', N'', N'Palais des Tuileries', N'75000', N'Paris', N'123', 500, 0);
